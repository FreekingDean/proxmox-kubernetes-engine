...
func (c *machinePoolServiceClient) GetMachinePool(ctx context.Context, in *GetMachinePoolRequest, opts ...grpc.CallOption) (*MachinePool, error) {
	out := new(MachinePool)
	err := c.cc.Invoke(ctx, MachinePoolService_GetMachinePool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machinePoolServiceClient) ListMachinePools(ctx context.Context, in *ListMachinePoolsRequest, opts ...grpc.CallOption) (*ListMachinePoolsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MachinePoolService_ListMachinePools_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machinePoolServiceClient) CreateMachinePool(ctx context.Context, in *CreateMachinePoolRequest, opts ...grpc.CallOption) (*MachinePool, error) {
	out := new(MachinePool)
	err := c.cc.Invoke(ctx, MachinePoolService_CreateMachinePool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machinePoolServiceClient) UpdateMachinePool(ctx context.Context, in *UpdateMachinePoolRequest, opts ...grpc.CallOption) (*MachinePool, error) {
	out := new(MachinePool)
	err := c.cc.Invoke(ctx, MachinePoolService_UpdateMachinePool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machinePoolServiceClient) DeleteMachinePool(ctx context.Context, in *DeleteMachinePoolRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, MachinePoolService_DeleteMachinePool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMachinePoolServiceServer must be embedded to have forward compatible implementations.
