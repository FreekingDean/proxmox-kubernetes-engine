...
var (
	filter_MachineService_ListMachines_0 = &utilities.DoubleArray{Encoding: map[string]int{"parent": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func RegisterMachineServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MachineServiceServer) error {
	...
	mux.Handle("GET", pattern_MachineService_GetMachine_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proxmox_kubernetes_engine.v1.MachineService/GetMachine", runtime.WithHTTPPathPattern("/v1/{name=nodePools/*/machines/*}"))
		if err != nil {
	...
	mux.Handle("GET", pattern_MachineService_ListMachines_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proxmox_kubernetes_engine.v1.MachineService/ListMachines", runtime.WithHTTPPathPattern("/v1/{parent=nodePools/*}/machines"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMachineServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MachineServiceClient) error {
	...
	mux.Handle("GET", pattern_MachineService_GetMachine_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proxmox_kubernetes_engine.v1.MachineService/GetMachine", runtime.WithHTTPPathPattern("/v1/{name=nodePools/*/machines/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_MachineService_ListMachines_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proxmox_kubernetes_engine.v1.MachineService/ListMachines", runtime.WithHTTPPathPattern("/v1/{parent=nodePools/*}/machines"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_MachineService_GetMachine_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3}, []string{"v1", "nodePools", "machines", "name"}, ""))

	pattern_MachineService_ListMachines_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 2, 5, 2, 2, 3}, []string{"v1", "nodePools", "parent", "machines"}, ""))
)
